...
-- "cilantro" is deliberately absent: UK usage is coriander, and the alias below
-- points at whichever coriander row the home actually has.
-- ---------------------------------------------------------------------------
...
INSERT INTO semantic_merge_ids (old_uuid, new_uuid, from_name)
SELECT old_i.uuid, new_i.uuid, m.from_name
